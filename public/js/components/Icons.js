/**
 * Icons.js
 * Centralized registry of SVG icons (Lucide style)
 * Replaces emojis with professional vector graphics.
 */
...
export const Icons = {
  ...
  Film: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>`,
  ...
  // Custom SVG Logo (Vinyl Record with Flame)
  MJRPLogo: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="none">
      <defs>
        <linearGradient id="flameGrad" x1="20" y1="80" x2="80" y2="20" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stop-color="#FF4D00"/>
          <stop offset="50%" stop-color="#FF8800"/>
          <stop offset="100%" stop-color="#FFCC00"/>
        </linearGradient>
        <radialGradient id="vinylGrad" cx="50" cy="50" r="45" gradientUnits="userSpaceOnUse">
      ...
      <!-- Flame Background -->
      <path d="M50 5 C30 20, 10 40, 15 65 C20 90, 45 95, 50 95 C55 95, 80 90, 85 65 C90 40, 70 20, 50 5 Z" fill="url(#flameGrad)" opacity="0.8"/>
      <path d="M50 15 C40 30, 30 45, 35 60 C40 75, 50 80, 50 80 C50 80, 60 75, 65 60 C70 45, 60 30, 50 15 Z" fill="#FFF" opacity="0.2"/>

      <!-- Vinyl Record -->
      <circle cx="50" cy="55" r="30" fill="url(#vinylGrad)" stroke="#333" stroke-width="1"/>
      <!-- Grooves -->
      <circle cx="50" cy="55" r="24" stroke="#444" stroke-width="0.5" fill="none"/>
      <circle cx="50" cy="55" r="18" stroke="#444" stroke-width="0.5" fill="none"/>
      <circle cx="50" cy="55" r="12" stroke="#444" stroke-width="0.5" fill="none"/>
      <!-- Label -->
      <circle cx="50" cy="55" r="8" fill="#FF4D00"/>
  ...
  // Missing icons added for full coverage
  ...
  // Apple logo for Apple Music export
  ...
  // Missing Icons added for Blending Menu
  ...
  ListMusic: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15V6"/><path d="M18.5 18a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/><path d="M12 12H3"/><path d="M16 6H3"/><path d="M12 18H3"/></svg>`,
  Users: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>`,
  GitMerge: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><path d="M6 21V9a9 9 0 0 0 9 9"/></svg>`,
...
/**
 * Helper to render an icon with optional class
