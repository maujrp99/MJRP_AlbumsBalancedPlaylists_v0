 ...
 * @param {string} context.searchQuery - Search query string
 * @param {Object} context.filters - Filter state { artist, year, source }
 * @param {string} context.filterMode - 'all' | 'ranked' | 'unranked'
 * @returns {Array} Filtered albums
 */
export function filterAlbums(albums, context = {}) {
    const { searchQuery = '', filters = {}, filterMode = 'all' } = context;
    let filtered = albums;
