---
description: ### 1. Specification Phase (`spec.md`) do SDD
---

### 1. Specification Phase (`spec.md`)
**Goal**: Define WHAT, WHY, and Success Criteria of a given set o human user requirements. No implementation details.
